namespace ClassesConfig
{
	...
	//set this true to allow builder classes even in TDM and DTS
	const bool forceAllowBuilder = false;
...
{
	string[] classes;
	if(ClassesConfig::builder && (allowBuilder || ClassesConfig::forceAllowBuilder))
	{
	...
	if(ClassesConfig::warcrafter && (allowBuilder || ClassesConfig::forceAllowBuilder))
	{
	...
	if(ClassesConfig::demolitionist && (allowBuilder || ClassesConfig::forceAllowBuilder))
	{
	...
	if(ClassesConfig::chopper && (allowBuilder || ClassesConfig::forceAllowBuilder))
	{
