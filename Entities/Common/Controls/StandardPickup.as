...
void onInit(CBlob@ this)
{
	...
	if (menu.entries.length == 0)
	{
		...
		const PickupWheelOption[] smokeball_options = {PickupWheelOption("smokeball", 1), PickupWheelOption("mat_smokeball", 0)};
		menu.add_entry(PickupWheelMenuEntry("Smoke Ball", "$mat_smokeball$", smokeball_options, menuOffset));
		...
		menu.add_entry(PickupWheelMenuEntry("Poisonous Meats", "$mat_poisonmeats", "mat_poisonmeats", menuOffset));
		menu.add_entry(PickupWheelMenuEntry("Oil Bottle", "$mat_cookingoils", "mat_cookingoils", menuOffset));
		menu.add_entry(PickupWheelMenuEntry("Bomb Box", "$mat_bombboxes", "mat_bombboxes", menuOffset));
		menu.add_entry(PickupWheelMenuEntry("Boomerangs", "$mat_boomerangs$", "mat_boomerangs", menuOffset));
		menu.add_entry(PickupWheelMenuEntry("Chakrams", "$mat_chakrams", "mat_chakrams", menuOffset));
		...
		menu.add_entry(PickupWheelMenuEntry("Bucket", "$filled_bucket$", "bucket", menuOffset));
	}
