//added scripts for dirt and repailable
...
bool isBuildableAtPos(CBlob@ this, Vec2f p, TileType buildTile, CBlob @blob, bool &out sameTile)
{
	...
	else if (buildTile == CMap::tile_ground && backtile.type >= CMap::tile_ground_d1 && backtile.type <= CMap::tile_ground_d0)//added here
	{
		//also can repair dirt
	}*/
	else if (buildTile == CMap::tile_ground && backtile.type != CMap::tile_ground_back)//added here
	{
		//can build only on dirt back
		return false;
	}
