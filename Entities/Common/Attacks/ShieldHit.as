...
// added new hitters to blockable, also script for weaponthrower
...
bool canBlockThisType(u8 type) // this function needs to use a tag on the hitterBlob, like ("bypass shield")
{
	return type == Hitters::stomp ||
	       ...
	       type == Hitters::thrownrock || // added from here
	       type == Hitters::hammer ||
	       ...
	       type == Hitters::shovel ||
	       type == Hitters::axe ||
	       type == Hitters::mattock ||
	       type == Hitters::warhammer ||
	       type == Hitters::flail ||
	       type == Hitters::rapier ||
	       type == Hitters::boomerang ||
	       type == Hitters::chakram ||
	       type == Hitters::firelance ||
	       type == Hitters::stick ||
	       type == Hitters::kitchenknife ||
	       type == Hitters::thrownaxe ||
	       type == Hitters::pike_thrust ||
	       type == Hitters::pike_slash ||
	       type == Hitters::handaxe ||
