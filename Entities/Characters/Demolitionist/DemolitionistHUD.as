...
const string iconsFilename = "Entities/Characters/Demolitionist/DemolitionistIcons.png";
...
void onRender(CSprite@ this)
{
	...
	// draw class icon
	GUI::DrawIcon(iconsFilename, action, Vec2f(16, 32), tl + Vec2f(8 + (slotsSize - 1) * 40, -16), 1.0f, blob.getTeamNum());
