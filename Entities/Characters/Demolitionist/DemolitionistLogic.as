...
void onInit(CBlob@ this)
{
	...
	SetHelp(this, "help self action2", "demolitionist", getTranslatedString("$Pick$Dig/Chop (change in inventory)$KEY_HOLD$$LMB$"), "", 255);
	SetHelp(this, "help self action2", "demolitionist", getTranslatedString("$Grapple$ Grappling hook    $RMB$"), "", 255);
...
void onTick(CBlob@ this)
{
	...
	if (ismyplayer)
	{
		...
		if (u_showtutorial && !this.hasTag("spoke description"))
		{
			...
			this.Chat("Destroy the structures!\n\n[LMB] to pickaxe or build(select in inventory)\n[RMB] to grapple\nAlso can use the drill");
...
void onAddToInventory(CBlob@ this, CBlob@ blob)
{
	...
	{
		SetHelp(this, "help inventory", "demolitionist", "$Help_Block1$$Swap$$Help_Block2$           $KEY_HOLD$$KEY_F$", "", 3);
	}
}
