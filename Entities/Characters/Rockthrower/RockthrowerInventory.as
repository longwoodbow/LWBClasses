...
void rockHelp(CBlob@ this)
{
	if (this.isMyPlayer())
	{
		SetHelp(this, "help self action", "rockthrower", getTranslatedString("$HelpRock$Throw Rocks  $LMB$"), "", 255);
		SetHelp(this, "help self action", "rockthrower", getTranslatedString("$boulder$Construct Boulder When select throwing(5sec cooldown)$KEY_SPACE$"), "", 255);
	}
}
