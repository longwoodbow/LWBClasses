...
void onInit(CInventory@ this)
{
	...
	AddIconToken("$Help_Axe$", "Entities/Common/GUI/HelpIcons.png", Vec2f(16, 16), 13);
	AddIconToken("$Help_ChopperTool1$", "Entities/Common/GUI/LWBHelpIcons.png", Vec2f(8, 16), 40);
	AddIconToken("$Help_ChopperTool2$", "Entities/Common/GUI/LWBHelpIcons.png", Vec2f(8, 16), 41);
	SetHelp(blob, "help inventory", "chopper", "$Help_ChopperTool1$$Swap$$Help_ChopperTool2$           $KEY_HOLD$$KEY_F$", "", 255);
	SetToolHelp(blob, ToolType::axe);
...
void SetToolHelp(CBlob@ this, u8 toolType)
{
	if (toolType == ToolType::mattock) SetHelp(this, "help self action2", "chopper", getTranslatedString("$Pick$Dig/Chop  $KEY_HOLD$$RMB$"), "", 255);
	else if (toolType == ToolType::axe) SetHelp(this, "help self action2", "chopper", getTranslatedString("$Help_Axe$Chop        $RMB$"), "", 255);
}
