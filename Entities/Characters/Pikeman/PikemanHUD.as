...
const string iconsFilename = "Entities/Characters/Pikeman/PikemanIcons.png";
...
void ManageCursors(CBlob@ this)
{
	...
	else
	{
		...
		{
			getHUD().SetCursorImage("Entities/Characters/Pikeman/PikemanCursor.png", Vec2f(32, 32));
...
void onRender(CSprite@ this)
{
	...
	GUI::DrawIcon(iconsFilename, 0, Vec2f(16, 32), tl + Vec2f(8 + (slotsSize - 1) * 40, -13), 1.0f, blob.getTeamNum());
}
