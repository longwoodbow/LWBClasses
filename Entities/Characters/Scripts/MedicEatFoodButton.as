...
void onTick(CBlob@ this)
{
	if (isServer() &&
		...
		else if (this.getBlobCount("mat_medkits") > 0)// added, can heal yourself using med kits if you are medic
		{
			MedicInfo@ medic;
			...
			if(medic.healTimer == 0)
			{
				...
				this.SendCommand(this.getCommandID("healally client"), params);
				medic.healTimer = healSelfPrep;
			}
		}
