...
int getHeadFrame(CBlob@ blob, int headIndex, bool default_pack)
{
	...
	if (default_pack && (headIndex == 255 || headIndex < NUM_UNIQUEHEADS))
	{
		...
		else if (config == "warhammer")
		{
			headIndex = NUM_UNIQUEHEADS + 16;
		}
		else if (config == "duelist")
		{
			headIndex = NUM_UNIQUEHEADS + 22;
		}
		else if (config == "weaponthrower")
		{
			headIndex = NUM_UNIQUEHEADS + 15;
		}
		else if (config == "firelancer")
		{
			headIndex = NUM_UNIQUEHEADS + 9;
		}
		...
		{
			headIndex = NUM_UNIQUEHEADS + 4;
		}
		else if (config == "butcher")
		{
			headIndex = NUM_UNIQUEHEADS + 27;
		}
