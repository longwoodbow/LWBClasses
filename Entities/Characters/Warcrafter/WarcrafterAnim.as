// Warcrafter animations
// alomst same with builder, except texture...
...
void LoadSprites(CSprite@ this)
{
	...
	case PLAYER_ARMOUR_STANDARD:
		ensureCorrectRunnerTexture(this, "warcrafter", "Warcrafter");
		break;
	case PLAYER_ARMOUR_CAPE:
		ensureCorrectRunnerTexture(this, "warcrafter_cape", "WarcrafterCape");
		break;
	case PLAYER_ARMOUR_GOLD:
		ensureCorrectRunnerTexture(this, "warcrafter_gold", "WarcrafterGold");
		break;
	}
...
void onTick(CSprite@ this)
{
	...
	if (!blob.hasTag(burning_tag)) //give way to burning anim
	{
		...
		else if (blob.get_u8("axe_delay") > 0)
		{
			this.SetAnimation("build_weapon");
			if (blob.get_u8("axe_delay") >= 30)
	...
	else if (action2 || blob.isInFlames() || (blob.get_bool("weapon_mode") && action1))
	{
...
void onGib(CSprite@ this)
{
	...
	CParticle@ Body     = makeGibParticle("Entities/Characters/Warcrafter/WarcrafterGibs.png", pos, vel + getRandomVelocity(90, hp , 80), 0, 0, Vec2f(16, 16), 2.0f, 20, "/BodyGibFall", team);
	CParticle@ Arm1     = makeGibParticle("Entities/Characters/Warcrafter/WarcrafterGibs.png", pos, vel + getRandomVelocity(90, hp - 0.2 , 80), 1, 0, Vec2f(16, 16), 2.0f, 20, "/BodyGibFall", team);
	CParticle@ Arm2     = makeGibParticle("Entities/Characters/Warcrafter/WarcrafterGibs.png", pos, vel + getRandomVelocity(90, hp - 0.2 , 80), 1, 0, Vec2f(16, 16), 2.0f, 20, "/BodyGibFall", team);
	CParticle@ Shield   = makeGibParticle("Entities/Characters/Warcrafter/WarcrafterGibs.png", pos, vel + getRandomVelocity(90, hp , 80), 2, 0, Vec2f(16, 16), 2.0f, 0, "Sounds/material_drop.ogg", team);
	CParticle@ Sword    = makeGibParticle("Entities/Characters/Warcrafter/WarcrafterGibs.png", pos, vel + getRandomVelocity(90, hp + 1 , 80), 3, 0, Vec2f(16, 16), 2.0f, 0, "Sounds/material_drop.ogg", team);
}
