...
void onCollision(CBlob@ this, CBlob@ blob, bool solid)
{
	...
	if (blobName == "mat_handcannonballs")
	{
		u32 bullets_count = this.getBlobCount("mat_handcannonballs");
		u32 blob_quantity = blob.getQuantity();
		if (bullets_count + blob_quantity <= 10)
		{
			this.server_PutInInventory(blob);
		}
		else if (bullets_count < 10) //merge into current bullet stacks
		{
