...
void onInit(CBlob@ this)
{
	...
	SetHelp(this, "help self action", "duelist", getTranslatedString("$Rapier$Rapier        $LMB$"), "", 255);
	SetHelp(this, "help self hide", "duelist", getTranslatedString("Hide    $KEY_S$"), "", 255);
	SetHelp(this, "help self action2", "duelist", getTranslatedString("$Grapple$ Grappling hook    $RMB$"), "", 255);
...
class CutState : DuelistState
{
	...
	bool TickState(CBlob@ this, DuelistInfo@ duelist, RunnerMoveVars@ moveVars)
	{
		...
		else if (delta > DELTA_BEGIN_ATTACK && delta < DELTA_END_ATTACK)
		{
			...
			DoAttack(this, 1.0f, -(vec.Angle()), 60.0f, Hitters::rapier, delta, duelist);//half arc
		}
...
void onHitBlob(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitBlob, u8 customData)
{
	...
	if (customData == Hitters::rapier && duelist.state == DuelistStates::rapier_cut && blockAttack(hitBlob, velocity, 0.0f))
	{
