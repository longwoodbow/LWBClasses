...
void onInit(CBlob@ this)
{
	...
	SetHelp(this, "help self action", "weaponthrower", getTranslatedString("$Help_Weapon$Throw        $LMB$"), "", 255);
	SetHelp(this, "help self action2", "weaponthrower", getTranslatedString("$Shield$Shield    $KEY_HOLD$$RMB$"), "", 255);
...
void onTick(CBlob@ this)
{
	...
	if (u_showtutorial && myplayer && !this.hasTag("spoke description"))
	{
		...
		this.Chat("Ranged attack and shield!\n\n[LMB] to throw/double throw\n[RMB] to use shield\n[SHIFT]&[SPACE] to pickup thrown chakram");
	...
	*/
	...
	if (myplayer)
	{
		...
		{
			SetHelp(this, "help self action", "weaponthrower", getTranslatedString("$Help_Weapon$ Throw!    $KEY_HOLD$$LMB$"), "", 255);
		}
	}
