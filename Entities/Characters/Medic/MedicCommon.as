...
//preparation
const u8 healPrep = 45;
const u8 healSelfPrep = 75;
...
bool hasJars(CBlob@ this, u8 sprayType)
{
	return sprayType < SprayType::count && this.getBlobCount(sprayTypeNames[sprayType]) > 0;
}