	...
	{
		{
			...
			AddRequirement(s.requirements, "coin", "", "Coins", LWB_CTFCosts::quarter_oilbottles);
		}
		{
			ShopItem@ s = addShopItem(this, "Poisonous Meat", "$mat_poisonmeats$", "mat_poisonmeats", "Poisonous Meat for Butcher.\nRight Click to throw.", true);
			AddRequirement(s.requirements, "coin", "", "Coins", LWB_CTFCosts::quarter_poisonmeats);
		}
	}
}
