...
void onTick(CBlob@ this)
{
		if( this.getTeamNum() < 3 && this.get_u32("minionCD") > 800)
		{
			...
			SpawnMook(this, pos, "assassin_moba", this.getTeamNum());
			SpawnMook(this, pos + Vec2f(10.0f, 0.0f), "duelist_moba", this.getTeamNum());
			SpawnMook(this, pos + Vec2f(-10.0f, 0.0f), "chopper_moba", this.getTeamNum());
			this.set_u32("minionCD", 0);
		}
		else 
