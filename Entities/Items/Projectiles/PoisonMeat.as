...
void onCollision(CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1)
{
	if (blob !is null && doesCollideWithBlob(this, blob) && !this.hasTag("collided"))
	{
		...
		dmg = MeatHitBlob(this, point1, initVelocity, dmg, blob, Hitters::poisoning);
		...
		if (dmg > 0.0f)
		{
			...
			//this.server_Hit(blob, point1, initVelocity, 0.0f, Hitters::bite);// temp damage
...
void Pierce(CBlob @this, CBlob@ blob = null)
{
	...
	{
		MeatHitMap(this, end, this.getOldVelocity(), 0.5f, Hitters::poisoning, blob);
	}
}
...
f32 MeatHitBlob(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitBlob, u8 customData)
{
	if (hitBlob !is null)
	{
		...
		else// don't want to give poison for shielded knight, old style
		{
			damage = 0.0f;
		}
...
void onHitBlob(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitBlob, u8 customData)
{
	...
	if (this !is hitBlob && customData == Hitters::poisoning)
	{
