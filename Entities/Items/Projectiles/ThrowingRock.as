...
void Pierce(CBlob @this, CBlob@ blob = null)
{
	...
	{
		RockHitMap(this, end, this.getOldVelocity(), 0.5f, Hitters::thrownrock, blob);
	}
}
	...
	if (hitBlob !is null)
	{
		...
		if (!hitShield)
		{
			...
			else
			{
				...
				{
					this.getSprite().PlaySound("Rubble?.ogg");
				}
			}
		}
...
void RockHitMap(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, u8 customData, CBlob@ hitBlob = null)
{
	if (velocity.Length() > rockFastSpeed)
	{
		this.getSprite().PlaySound("rock_hit?.ogg");
