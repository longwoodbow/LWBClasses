...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	if (cmd == this.getCommandID("activate") && isServer())
	{
		...
		{
			addLoot(this, INDEX_WEAPONTHROWER, 1, 0);
		}
		else if (NAME == "firelancer")
		{
			addLoot(this, INDEX_FIRELANCER, 1, 0);
		}
		else if (NAME == "gunner")
		{
			addLoot(this, INDEX_GUNNER, 1, 0);
		}
		else if (NAME == "warcrafter")
		{
			addLoot(this, INDEX_WARCRAFTER, 1, 0);
		}
		else if (NAME == "butcher")
		{
			addLoot(this, INDEX_BUTCHER, 1, 0);
		}
		else if (NAME == "demolitionist")
		{
			addLoot(this, INDEX_DEMOLITIONIST, 1, 0);
		}
		else if (NAME == "chopper")
		{
			addLoot(this, INDEX_CHOPPER, 1, 0);
		}
		else if (NAME == "warhammer")
		{
			addLoot(this, INDEX_WARHAMMER, 1, 0);
		}
