		...
		if(alpha < 255)
		{
			...
			case map_colors::alpha_magazine:
			{
				...
				if(alpha == items.length) // random
				{
					...
					{
						randomItem.push_back("mat_bombs");
						randomItem.push_back("mat_waterbombs");
					}
					if(ClassesConfig::assassin)
					{
						randomItem.push_back("mat_smokeball");
					}
					if(ClassesConfig::archer || ClassesConfig::crossbowman)
					{
						randomItem.push_back("mat_arrows");
						randomItem.push_back("mat_firearrows");
						randomItem.push_back("mat_poisonarrows");
						if(ClassesConfig::archer)
						{
							randomItem.push_back("mat_waterarrows");
							randomItem.push_back("mat_bombarrows");
						}
					}
					if(ClassesConfig::musketman || ClassesConfig::gunner)
					{
						randomItem.push_back("mat_bullets");
					}
					if(ClassesConfig::weaponthrower)
					{
						randomItem.push_back("mat_boomerangs");
						randomItem.push_back("mat_chakrams");
					}
					if(builderItems || ClassesConfig::rockthrower)
					{
						randomItem.push_back("drill");
						randomItem.push_back("mat_wood");
						randomItem.push_back("mat_stone");
						if(builderItems && ClassesConfig::demolitionist)
						{
							randomItem.push_back("mat_bombboxes");
						}
					}
					if(ClassesConfig::medic)
					{
						randomItem.push_back("mat_medkits");
						randomItem.push_back("mat_waterjar");
						randomItem.push_back("mat_poisonjar");
						randomItem.push_back("mat_acidjar");
					}
