				...
				if (player.team == team_num)
				{
					...
					if (e_player !is null)
					{
						...
						if (blob_alive)
						{
							...
							else if (player_blob.getName() == "warhammer")
							{
								player_char = "h";
							}
							else if (player_blob.getName() == "duelist")
							{
								player_char = "d";
							}
							else if (player_blob.getName() == "weaponthrower")
							{
								player_char = "w";
							}
							else if (player_blob.getName() == "firelancer")
							{
								player_char = "f";
							}
							else if (player_blob.getName() == "gunner")
							{
								player_char = "g";
							}
