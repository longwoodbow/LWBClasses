...
void MakeTradeMenu(CBlob@ trader)
{
	...
	if(ClassesConfig::spearman)addItemForCoin(trader, "Poison Spears", LWB_TDMCosts::cost_poisonspears, true, "$mat_poisonspears$", "mat_poisonspears", "Poison Spears for Spearman. Make spear attacking or thrown spear poisonable twice.");
	...
	if(ClassesConfig::medic)addItemForCoin(trader, "Poison in a Jar", LWB_TDMCosts::cost_poisonjar, true, "$mat_poisonjar$", "mat_poisonjar", "Poison for Medic Spray.");
