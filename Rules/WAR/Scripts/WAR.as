...
//	addTradeScrollFromScrollDef(trader, "saw", cost_crappiest, Descriptions::saw);
	...
	addTradeScrollFromScrollDef(trader, "crankedgun", WARCosts::super_scroll, "Manual machine gun. This a little overtechnology weapon can shoot a lot of bullets.");
	addTradeScrollFromScrollDef(trader, "cannon", WARCosts::super_scroll, "Very powerful siege, it makes you to break dense walls easier.");
	addTradeScrollFromScrollDef(trader, "bomber", WARCosts::super_scroll, "Hot Balloon that can carry a siege.");
	...
	addTradeScrollFromScrollDef(trader, "acid", WARCosts::crappy_scroll, "The matter that found in in research of alchemy. Can melt manythings.");
	addTradeScrollFromScrollDef(trader, "bomb ball", WARCosts::crappy_scroll, "Explode when drop or launch by catapult.\nIt doesn't hurt allies, but be careful.");
