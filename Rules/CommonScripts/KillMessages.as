	...
	void Render()
	{
		...
		for (uint message_step = 0; message_step < count; ++message_step)
		{
			...
			switch (message.hitter)
			{
				...
				case Hitters::axe:				hitterIcon = "$killfeed_axe$"; break;
				case Hitters::warhammer:		hitterIcon = "$killfeed_warhammer$"; break;
				case Hitters::flail:			hitterIcon = "$killfeed_frail$"; break;
				case Hitters::rapier:			hitterIcon = "$killfeed_rapier$"; break;
				case Hitters::boomerang:		hitterIcon = "$killfeed_boomerang$"; break;
				case Hitters::chakram:			hitterIcon = "$killfeed_chakram$"; break;
				case Hitters::firelance:		hitterIcon = "$killfeed_firelance$"; break;
				case Hitters::stick:			hitterIcon = "$killfeed_stick$"; break;
				case Hitters::kitchenknife:		hitterIcon = "$killfeed_kitchenknife$"; break;
...
void onInit(CRules@ this)
{
	...
	AddIconToken("$killfeed_warhammer$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 10);
	AddIconToken("$killfeed_frail$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 11);
	AddIconToken("$killfeed_rapier$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 12);
	AddIconToken("$killfeed_boomerang$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 13);
	AddIconToken("$killfeed_chakram$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 14);
	AddIconToken("$killfeed_firelance$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 15);
	AddIconToken("$killfeed_stick$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 16);
	AddIconToken("$killfeed_kitchenknife$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 17);
